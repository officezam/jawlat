...
if( !function_exists( 'create_city_post_type' ) ){
    function create_city_post_type(){
      ...
      $labels = array(
        'name' => __( 'Hotels & Resturants'),
        'singular_name' => __( 'Hotels & Resturants' ),
        'add_new' => __('Add New'),
...
function city_meta_box_cb( $post )
{
    ...
    <p>
        <label for="city_meta_box_state"><strong>City:</strong> </label>
        </p>
        <select name="city_meta_box_state" id="city_meta_box_state" class="required" required  title="Please Select City">
...
if( !function_exists( 'cities_edit_columns' ) ){
    function cities_edit_columns($columns)
    {
        ...
        $columns = array(
            ...
            "title" => __( 'Hotel Title','framework' ),
            "state" => __( 'City','framework' ),
